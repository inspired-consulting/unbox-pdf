...
public class SimplePdf {
    ...
    public static void main(String[] args) throws IOException {
        ...
        var table = new FixedColumnsTable(tableModel)
        ...
        table.addRow()
            .withCells("SmartPhone", "5,5", "320.00 EUR");
        ...
        document.render(paragraph("Done!", helvetica_bold(12, Color.RED), Align.LEFT)
            .with(Padding.of(10,10))
            .with(border(2, RED_ORANGE)));

        document.render(paragraph("Forcierterumbruchinlangwortsatzohneleerzeichentest", helvetica_bold(22), Align.CENTER)
            .with(Padding.of(20, 30))
            .with(border(2, RED_ORANGE))
            .with(background(GRAY_100)));
